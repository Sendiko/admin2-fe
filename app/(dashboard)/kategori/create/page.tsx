...
export default function CreateKategoriPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.post("/kategori", { nama });
      ...
      setSuccessMsg("Kategori berhasil didaftarkan!");
      setTimeout(() => {
      ...
      if (err.message.includes("Failed to fetch")) {
        setSuccessMsg("API Offline: Kategori disimulasikan secara lokal!");
        setTimeout(() => {
          router.push("/kategori");
        }, 1500);
      } else {
    ...
    <div className="max-w-xl mx-auto flex flex-col gap-6 animate-fade-in-up">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
        <div>
          ...
          <h2 className="text-xl font-bold text-slate-900 dark:text-slate-50">Daftar Kategori Baru</h2>
        </div>
        <Link
          href="/kategori"
